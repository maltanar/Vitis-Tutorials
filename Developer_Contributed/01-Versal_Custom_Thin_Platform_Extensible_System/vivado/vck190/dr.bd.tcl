...
if { ${design_name} eq "" } {
  ...
  set_property USER_COMMENTS.comment0 "	 	 ======================= >>>>>>>>> An Example Versal Extensible Embedded Platform <<<<<<<<< =======================
				 ...
				 --> For Next steps, Refer to README.md https://github.com/Xilinx/XilinxCEDStore/tree/2023.2/ced/Xilinx/IPI/Versal_Extensible_Embedded_Platform/README.md" [get_bd_designs $design_name]
...
{PMC_MIO 26 .. 36}}} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CLKOUT_REQUESTED_OUT_FREQUENCY {500.000,333.333,300.000,100.000,100.000,100.000,100.000} \
  ...
  connect_bd_net -net CIPS_0_pl_resetn1 [get_bd_pins CIPS_0/pl0_resetn] [get_bd_pins clk_wizard_0/resetn] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins proc_sys_reset_2/ext_reset_in] [get_bd_pins proc_sys_reset_3/ext_reset_in] [get_bd_pins proc_sys_reset_4/ext_reset_in]
  ...
  connect_bd_net -net clk_wizard_0_clk_out1 [get_bd_pins clk_wizard_0/clk_out1_o3] [get_bd_pins CIPS_0/m_axi_fpd_aclk] [get_bd_pins cips_noc/aclk0] [get_bd_pins icn_ctrl/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins axi_intc_0/s_axi_aclk]
  connect_bd_net -net clk_wizard_0_clk_out1_o1 [get_bd_pins clk_wizard_0/clk_out1_o1] [get_bd_pins proc_sys_reset_1/slowest_sync_clk]
  connect_bd_net -net clk_wizard_0_clk_out1_o2 [get_bd_pins clk_wizard_0/clk_out1_o2] [get_bd_pins proc_sys_reset_2/slowest_sync_clk]
  connect_bd_net -net clk_wizard_0_clk_out1_o4 [get_bd_pins clk_wizard_0/clk_out1_o4] [get_bd_pins proc_sys_reset_3/slowest_sync_clk]
  connect_bd_net -net clk_wizard_0_clk_out2 [get_bd_pins clk_wizard_0/clk_out2] [get_bd_pins proc_sys_reset_4/slowest_sync_clk]
  connect_bd_net -net clk_wizard_0_locked [get_bd_pins clk_wizard_0/locked] [get_bd_pins proc_sys_reset_0/dcm_locked] [get_bd_pins proc_sys_reset_4/dcm_locked] [get_bd_pins proc_sys_reset_1/dcm_locked] [get_bd_pins proc_sys_reset_2/dcm_locked] [get_bd_pins proc_sys_reset_3/dcm_locked] [get_bd_pins clk_wizard_0/clk_out1_ce] [get_bd_pins clk_wizard_0/clk_out1_clr_n]
  ...
  set_property PFM.CLOCK {clk_out1_o1 {id "0" is_default "true" proc_sys_reset "/proc_sys_reset_1" status "fixed" freq_hz "500000000"} clk_out1_o2 {id "1" is_default "false" proc_sys_reset "/proc_sys_reset_2" status "fixed" freq_hz "250000000"} clk_out1_o3 {id "2" is_default "false" proc_sys_reset "/proc_sys_reset_0" status "fixed" freq_hz "125000000"} clk_out1_o4 {id "3" is_default "false" proc_sys_reset "/proc_sys_reset_3" status "fixed" freq_hz "62500000"} clk_out2 {id "4" is_default "false" proc_sys_reset "/proc_sys_reset_4" status "fixed" freq_hz "333333333"}} [get_bd_cells /clk_wizard_0]
